...
const Pagination = ({ page, totalPages, onPageChange }: Props) => {
  return (
    ...
    activeClassName={"font-bold bg-zinc-700 text-white rounded-md px-3 py-2"}
    
    pageClassName={
      "border border-gray-700 bg-zinc-900 text-white hover:bg-zinc-800 rounded-md px-3 py-2 transition-all"
    }
